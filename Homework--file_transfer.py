...
class ParentWindow (Frame):
    def __init__(self, master):
        ...
        self.sourceDirectoryButton = Button(text="Select Source", width=20, bg="papayawhip")
        self.sourceDirectoryButton.grid(row=0, column=0, padx=(20, 10), pady=(30,0))

        # Entry area for the source:
        self.sourceDirectory = Entry(width=75, bg="papayawhip")
        ...
        self.destinationDirectoryButton = Button(text="Select Destination", width=20, bg="lavender")
        self.destinationDirectoryButton.grid(row=1, column=0, padx=(20, 10), pady=(15, 10))

        # Entry area for the destination:
        self.destinationDirectory = Entry(width=75, bg="lavender")
